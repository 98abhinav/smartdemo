define(['app/app', 'angularAMD'], function (app, rolePoliciesModule)
{
    rolePoliciesModule.service('rolePoliciesService',
            [
                function ()
                {
    ...
    rolePoliciesModule.directive('rolePoliciesRepeatDirective', function () {
    ...
    rolePoliciesModule.factory('rolePoliciesFactory', ['$http', '$rootScope', function ($http, $rootScope) {
    ...
    rolePoliciesModule.factory('rolePoliciesPageFactory', ['$q', '$timeout', 'rolePoliciesFactory', function ($q, $timeout, rolePoliciesFactory) {
