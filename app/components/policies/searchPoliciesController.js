define(['app/app', 'angularAMD', 'smartTable', 'ngScrollbar'], function (app, policiesModule, smartTable, ngScrollbar)
{
    ...
    policiesModule.controller('searchRolePoliciesController',
            [
    ...
    policiesModule.controller('searchUserPoliciesController',
            [
    ...
    policiesModule.controller('searchGroupPoliciesController',
            [
