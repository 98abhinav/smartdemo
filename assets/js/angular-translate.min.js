...
angular.module("pascalprecht.translate", ["ng"]).run(["$translate", function (a) {
            ...
            return void 0 === a ? z : (z = a, this)
                ...
                var s, y, B, C = b.get(l || "$translateDefaultInterpolation"), L = !1, M = {}, N = {}, O = function (a, b, d, f) {
                    ...
                    return b.get(m)(f).then(function (b) {
                        ...
                        }) : angular.extend(e, H(b)), L = !1, c.resolve({key: a, table: e}), d.$emit("$translateLoadingEnd", {language: a})
                    }, function (a) {
        ...
        return{restrict: "AE", scope: !0, priority: a.directivePriority(), compile: function (b, h) {
