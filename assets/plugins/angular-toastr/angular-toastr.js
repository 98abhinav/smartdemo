...
(function() {
  ...
  angular.module('toastr')
    .constant('toastrConfig', {
      ...
      target: 'body',
      templates: {
        toast: 'assets/plugins/angular-toastr/directives/toast/toast.html',
        progressbar: 'assets/plugins/angular-toastr/directives/progressbar/progressbar.html'
      },
      timeOut: 0,	//5000
  ...
  function toast($injector, $interval, toastrConfig, toastr) {
    ...
    function toastLinkFunction(scope, element, attrs, toastCtrl) {
      ...
      scope.close = function (wasClicked) {
    	...
    	document.getElementById("toastrOverlay").style.display='none';
      };
